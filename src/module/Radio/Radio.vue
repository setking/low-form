<template>
  <div v-if="!currentOptions.length" style="font-size: 12px">暂无选项</div>
  <el-radio-group v-model="selectVal" @change="selectChange" v-bind="$attrs">
...
const { selectVal, currentOptions, selectChange } = useSelect(props, emits)
